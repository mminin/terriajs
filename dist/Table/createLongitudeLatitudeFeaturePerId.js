...
function createFeature(featureId, rowIds, style) {
    ...
    rowIds.forEach(rowId => {
        ...
        addSampleOrInterval(position, Cartesian3.fromDegrees(longitude, latitude, 0.0), interval);
        addSampleOrInterval(color, colorMap.mapValueToColor(colorValue), interval);
        addSampleOrInterval(pointSize, pointSizeMap.mapValueToPointSize(pointSizeValue), interval);
    ...
    propertiesBag.addProperty("_terria_getChartDetails", getChartDetailsFn(style, rowIds));
