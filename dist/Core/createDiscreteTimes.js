...
export default function createDiscreteTimesFromIsoSegments(result, startDate, stopDate, isoDuration, maxRefreshIntervals) {
    ...
    if (count >= maxRefreshIntervals) {
        console.warn("Interval has more than the allowed number of discrete times. Consider setting `maxRefreshIntervals`.");
    }
...
//# sourceMappingURL=createDiscreteTimes.js.map