    ...
    isActive(catalogItem, column) {
        ...
        return (defined(value[column.name]) &&
            ...
            value[column.name].regionColumn ===
                catalogItem.regionMapping.tableStructure.getColumnWithNameOrId(catalogItem.regionMapping.regionDetails[0].columnName) &&
    ...
    toggleEntireCatalogItem(catalogItem) {
        ...
        for (let i = 0; i < columns.length; ++i) {
            ...
            if (this.columnIsScalar(catalogItem, column)) {
                ...
                if ((!isActive && details.isEntirelyActive) ||
...
//# sourceMappingURL=RegionDataParameterEditor.js.map