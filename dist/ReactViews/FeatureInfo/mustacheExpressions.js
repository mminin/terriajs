 ...
 * @private
 */
export function mustacheRenderPartialByName(partials, templateData) {
    return () => {
        return mustacheJsonSubOptions((value, options) => {
 ...
 * @private
 */
export function formatDateTime(text, options) {
...
//# sourceMappingURL=mustacheExpressions.js.map