...
let SpectralDisplay = class SpectralDisplay extends React.Component {
    ...
    render() {
        ...
        if (this.props.viewState.spectralAtomic) {
            ...
            if (currentImage != this.props.viewState.spectralDataObject.image_id) {
                ...
                this.apiRequest(this.props.viewState.spectralDataObject, true);
                currentImage = this.props.viewState.spectralDataObject.image_id;
                this.props.viewState.setSpectralAtomic(false);
            }
            else {
                console.log("Adding to array");
                this.apiRequest(this.props.viewState.spectralDataObject, false);
                this.props.viewState.setSpectralAtomic(false);
            }
        }
        ...
        if (this.props.viewState.spectralProfileActive) {
            return (React.createElement(DragWrapper, null,
                React.createElement("div", { style: style },
                    React.createElement(Plot, { data: graphArray, layout: {
                            width: 800,
                            height: 500,
                ...
                React.createElement("div", { className: "plot-btn-group" },
                    React.createElement("button", { onClick: () => this.resetPlot() },
                        React.createElement("span", null, "Reset")),
                    React.createElement("button", { onClick: () => this.downloadCSV() },
                        React.createElement("span", null, "Download CSV")))));
        }
        else {
...
SpectralDisplay.PropTypes = {
    viewState: PropTypes.object.isRequired,
};
SpectralDisplay = __decorate([
    observer
], SpectralDisplay);
export default SpectralDisplay;
//# sourceMappingURL=SpectralDisplay.js.map