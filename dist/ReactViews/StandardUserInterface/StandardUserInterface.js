...
const StandardUserInterface = observer(createReactClass({
    ...
    render() {
        ...
        return (React.createElement(ThemeProvider, { theme: mergedTheme },
            ...
            this.props.viewState.printWindow && (React.createElement(PrintView, { window: this.props.viewState.printWindow, terria: terria, viewState: this.props.viewState, closeCallback: () => this.props.viewState.setPrintWindow(null) }))));
    }
}));
