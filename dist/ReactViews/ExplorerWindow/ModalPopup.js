...
const ModalPopup = createReactClass({
    ...
    render() {
        ...
        return visible ? (React.createElement("div", { className: classNames(Styles.modalWrapper, this.props.isTopElement ? "top-element" : ""), id: "explorer-panel-wrapper", "aria-hidden": !visible },
            React.createElement("div", { onClick: this.props.onClose, id: "modal-overlay", className: Styles.modalOverlay, tabIndex: "-1" }),
            React.createElement("div", { id: "explorer-panel", className: classNames(Styles.explorerPanel, Styles.modalContent, {
                    [Styles.isMounted]: this.state.slidIn
                }), "aria-labelledby": "modalTitle", "aria-describedby": "modalDescription", role: "dialog" },
                React.createElement("button", { type: "button", onClick: this.props.onClose, className: Styles.btnCloseModal, title: t("addData.closeDataPanel"), "data-target": "close-modal" }, t("addData.done")),
