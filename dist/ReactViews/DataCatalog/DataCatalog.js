    ...
    render() {
        ...
        return (React.createElement("ul", { className: Styles.dataCatalog },
            ...
            React.createElement(For, { each: "item", of: items }, item !== this.props.terria.catalog.userAddedDataGroup && (React.createElement(DataCatalogMember, { viewState: this.props.viewState, member: item, 
                ...
                manageIsOpenLocally: isSearching && !catalogSearchProvider.resultsAreReferences, key: item.uniqueId, onActionButtonClicked: this.props.onActionButtonClicked, removable: this.props.removable, terria: this.props.terria, isTopLevel: true })))));
    }
}));
