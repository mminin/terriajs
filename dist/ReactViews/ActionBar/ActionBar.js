...
export const ActionBar = (props) => {
    ...
    return viewState.useSmallScreenInterface ? null : (React.createElement(PortalChild, { viewState: viewState, portalId: ActionBarPortalId },
        React.createElement(ActionBarInner, null, props.children)));
};
