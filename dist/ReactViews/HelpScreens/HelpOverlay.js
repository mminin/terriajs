...
const HelpOverlay = createReactClass({
    ...
    render() {
        return (React.createElement("div", { "aria-hidden": !this.props.helpViewState.currentSequence },
            React.createElement(ObscureOverlay, { helpViewState: this.props.helpViewState }),
            React.createElement(HelpScreenWindow, { helpViewState: this.props.helpViewState })));
    }
});
/**
