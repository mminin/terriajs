...
const ObscureOverlay = createReactClass({
    ...
    render() {
        ...
        return (React.createElement("div", { className: windowClass, "aria-hidden": !helpScreen },
            ...
            React.createElement("div", { className: Styles.clearOverlay, onClick: this.advance })));
    }
});
module.exports = ObscureOverlay;
//# sourceMappingURL=ObscureOverlay.js.map