...
const TimerSection = observer(createReactClass({
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(If, { condition: this.isEnabled() },
                React.createElement("div", { className: Styles.section },
                    React.createElement("div", { className: Styles.timerContainer },
                        React.createElement(Timer, { tooltipText: t("timer.nextScheduledUpdateTime", {
                    ...
                    React.createElement("span", null, t("timer.nextScheduledUpdateCountdown", {
