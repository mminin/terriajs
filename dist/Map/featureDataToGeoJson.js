...
import { isFeature, isFeatureCollection } from "../ModelMixins/GeojsonMixin";
...
function convertGeoJson(featureData) {
    if (isFeatureCollection(featureData))
        return featureData;
    if (isFeature(featureData))
        return featureCollection([featureData]);
}
...
function getEsriFeature(featureData, geometryType) {
    let geojsonGeom;
    if (!(featureData === null || featureData === void 0 ? void 0 : featureData.geometry))
        return undefined;
