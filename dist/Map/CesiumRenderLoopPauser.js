...
export default class CesiumRenderLoopPauser {
    constructor(cesiumWidget, postRenderCallback) {
        ...
        document.addEventListener("keydown", this._boundNotifyRepaintRequired, false);
        ...
        const anyLoadWithXhr = loadWithXhr;
        this._originalLoadWithXhr = anyLoadWithXhr.load;
        anyLoadWithXhr.load = (url, responseType, method, data, headers, deferred, overrideMimeType, preferText, timeout) => {
            deferred.promise.always(this._boundNotifyRepaintRequired);
            return this._originalLoadWithXhr(url, responseType, method, data, headers, deferred, overrideMimeType, preferText, timeout);
        };
    ...
    destroy() {
        ...
        if (this._boundNotifyRepaintRequired) {
            ...
            document.removeEventListener("keyup", this._boundNotifyRepaintRequired, false);
            document.removeEventListener("keydown", this._boundNotifyRepaintRequired, false);
        }
...
//# sourceMappingURL=CesiumRenderLoopPauser.js.map