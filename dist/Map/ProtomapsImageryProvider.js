...
import { toFeatureCollection } from "../ModelMixins/GeojsonMixin";
...
export default class ProtomapsImageryProvider {
    constructor(options) {
        ...
        // Source object
        else if (options.data instanceof GeojsonSource ||
        ...
        this.labelers = new Labelers(document.createElement("canvas").getContext("2d"), this.labelRules, 16, () => undefined);
    }
