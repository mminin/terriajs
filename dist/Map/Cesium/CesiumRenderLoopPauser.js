...
export default class CesiumRenderLoopPauser {
    constructor(cesiumWidget, postRenderCallback) {
        ...
        anyLoadWithXhr.load = (url, responseType, method, data, headers, deferred, overrideMimeType, timeout, returnType) => {
            deferred.promise.finally(this._boundNotifyRepaintRequired);
            return this._originalLoadWithXhr(url, responseType, method, data, headers, deferred, overrideMimeType, timeout, returnType);
        };
