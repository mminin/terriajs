...
export class CartoLoadableStratum extends LoadableStratum(CartoMapCatalogItemTraits) {
...
export default class CartoMapCatalogItem extends MappableMixin(UrlMixin(CatalogMemberMixin(CreateModel(CartoMapCatalogItemTraits)))) {
    get type() {
...
CartoMapCatalogItem.type = "carto";
__decorate([
    computed
], CartoMapCatalogItem.prototype, "mapItems", null);
__decorate([
    computed
], CartoMapCatalogItem.prototype, "cacheDuration", null);
__decorate([
    computed
], CartoMapCatalogItem.prototype, "imageryProvider", null);
//# sourceMappingURL=CartoMapCatalogItem.js.map