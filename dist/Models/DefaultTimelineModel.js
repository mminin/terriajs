...
export default class DefaultTimelineModel extends DiscretelyTimeVaryingMixin(CreateModel(DiscretelyTimeVaryingTraits)) {
    constructor(uniqueId, terria) {
        ...
        this.setTrait(CommonStrata.defaults, "startTime", JulianDate.toIso8601(JulianDate.addHours(now, -12, new JulianDate())));
        this.setTrait(CommonStrata.defaults, "stopTime", JulianDate.toIso8601(JulianDate.addHours(now, 12, new JulianDate())));
    }
    get discreteTimes() {
        return undefined;
    }
