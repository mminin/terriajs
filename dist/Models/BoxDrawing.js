    ...
    createSide(planeLocal) {
        ...
        const moveBoxOnDragSide = (mouseMove) => {
            ...
            if (moveUpDown) {
                ...
                const endPosition = (_b = screenToGlobePosition(scene, mouseMove.endPosition, scratchEndPosition)) !== null && _b !== void 0 ? _b : scene.camera.pickEllipsoid(mouseMove.endPosition, undefined, scratchEndPosition);
    ...
    createScalePoint(pointLocal) {
        ...
        const scalePoint = new Entity({
            ...
            model: {
                ...
                () => 0.15 * Cartesian3.minimumComponent(this.trs.scale), false),
