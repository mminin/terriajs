...
BooleanParameterGroup.defaultUpdaters.OneForAll = function (functionParameter, json, propertyName, options) {
    functionParameter.OneForAll = makeBooleanEditorFromJson(json[propertyName], functionParameter.terria, functionParameter.catalogFunction);
};
BooleanParameterGroup.defaultUpdaters.ParameterList = function (functionParameter, json, propertyName, options) {
...
//# sourceMappingURL=BooleanParameterGroup.js.map