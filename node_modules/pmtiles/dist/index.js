...
export const shift = (n, shift) => {
    return n * Math.pow(2, shift);
};
export const unshift = (n, shift) => {
    return Math.floor(n / Math.pow(2, shift));
};
export const getUint24 = (view, pos) => {
    return shift(view.getUint16(pos + 1, true), 8) + view.getUint8(pos);
};
export const getUint48 = (view, pos) => {
...
export const queryLeafdir = (view, z, x, y) => {
...
export const queryTile = (view, z, x, y) => {
...
export const queryLeafLevel = (view) => {
...
export const createDirectory = (entries) => {
...
export const deriveLeaf = (root, tile) => {
...
export const leafletLayer = (source, options) => {
