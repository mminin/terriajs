...
import { CenteredTextSymbolizer, CircleSymbolizer, exp, FlexSymbolizer, GroupSymbolizer, LineLabelSymbolizer, LineSymbolizer, OffsetTextSymbolizer, PolygonLabelSymbolizer, PolygonSymbolizer, ShieldSymbolizer, } from "../symbolizer";
...
export const paintRules = (params, shade) => {
    ...
    return [
        ...
        },
        {
            ...
            filter: (z, f) => {
                return (f.props.landuse == "residential" || f.props.place == "neighbourhood");
            },
        },
        {
            dataLayer: "landuse",
    ...
    return [
        ...
        },
        {
            ...
            symbolizer: languageStack(new CenteredTextSymbolizer({
                ...
                font: (z, f) => {
                    if ((f === null || f === void 0 ? void 0 : f.props["pmap:rank"]) === 1) {
                        if (z > 8)
